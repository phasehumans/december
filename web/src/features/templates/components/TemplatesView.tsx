                            ...
                            <div className="mb-10 flex flex-col items-start gap-5">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <p className="max-w-xl text-sm leading-relaxed text-neutral-500">
                                        Discover websites, apps, components, and starters shared by
                                        the community — ready to remix, customize, and make your
                                        own.
                                    </p>
                                </div>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="max-w-xl text-[14.5px] leading-relaxed text-neutral-500">
                                    Explore {selectedCategory.label.toLowerCase()} templates built
                                    with the community. Launch high-converting pages with responsive
                                    layouts and on-brand design.
                                </p>
                            </div>
                        </motion.div>
                    )}
                    ...
                    <div>
                        ...
                        {filteredGridTemplates.length > 0 ? (
                            ...
                            >
                                ...
                                <h3 className="text-sm font-medium text-textMain mb-1.5">
                                    No templates found
                                </h3>
