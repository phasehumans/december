...
type ShapeHandle = 'n' | 's' | 'e' | 'w' | 'nw' | 'ne' | 'sw' | 'se'
...
interface CanvasResizeHandlesProps {
    ...
    onShapeHandleDown: (handle: ShapeHandle, e: React.PointerEvent<HTMLDivElement>) => void
    onLineHandleDown: (handle: LineHandle, e: React.PointerEvent<HTMLDivElement>) => void
}
