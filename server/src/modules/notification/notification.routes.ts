...
notificationRouter.post('/send-all', notificationController.sendNotificationToAll)
...
notificationRouter.delete('/read', notificationController.deleteAllReadNotifications)
