...
> = ({
    ...
    return (
        <button
            onClick={onClick}
            className={cn(
                'relative flex items-center gap-2 rounded-lg transition-colors group w-full font-sans outline-none border-none ring-0 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 active:outline-none active:ring-0',
                collapsed ? 'justify-center px-0 py-2' : 'justify-between px-3 py-[6px]',
                active
                    ? isSearch
