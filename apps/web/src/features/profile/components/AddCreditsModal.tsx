                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-[#181817] border border-[#2B2A27] rounded-xl pl-9 pr-4 py-4 text-white text-2xl font-mono font-medium focus:outline-none focus:border-white transition-colors shadow-inner"
                            placeholder="5"
