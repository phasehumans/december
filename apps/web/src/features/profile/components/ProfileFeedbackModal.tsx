            ...
            {showThankYou ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <textarea
                        ...
                        className="w-full bg-white/[0.03] border border-[#2B2A27] hover:border-[#383736] focus:border-[#4E4D49] focus:ring-1 focus:ring-[#4E4D49] rounded-lg p-3.5 text-[13px] text-white outline-none resize-none h-[110px] transition-[border-color,box-shadow] duration-200 placeholder:text-[#4A4948]"
