        ...
        >
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2 mt-2">
                    <div className="flex items-center justify-between border border-[#2B2A27] hover:border-[#383736] rounded-lg p-3 bg-transparent transition-all font-mono text-[12px] text-white">
